...
public static class Database
{
    ...
    public static string CurrentDbPath { get; private set; } = DbPath;
    public static void SetDbPath(string path)
    {
        if (!string.IsNullOrWhiteSpace(path)) CurrentDbPath = path;
    }
    public static string ConnectionString => new SqliteConnectionStringBuilder { DataSource = CurrentDbPath }.ToString();
    ...
    public static SqliteConnection Open()
    {
        ...
        cmd.CommandText = "PRAGMA foreign_keys=ON; PRAGMA busy_timeout=5000; PRAGMA journal_mode=WAL;";
        cmd.ExecuteNonQuery();
        return c;
    }
