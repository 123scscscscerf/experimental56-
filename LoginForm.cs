...
public sealed class LoginForm : Form
{
    ...
    public LoginForm()
    {
        ...
        var card = new Panel { Dock = DockStyle.Fill, Padding = new Padding(30), BackColor = ThemeManager.Back };
        var inner = new Panel { Dock = DockStyle.Top, Height = 160, BackColor = ThemeManager.Surface, Padding = new Padding(20) };
        var loginBtn = AppTheme.FlatButton("Login");
        loginBtn.Width = 120;
        ...
        fl.Controls.Add(new Label { Text = Loc.T("AppTitle"), AutoSize = true, Font = new Font(AppTheme.Font.FontFamily, 13, FontStyle.Bold) });
